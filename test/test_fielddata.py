...
class TestFieldData(TestCase):
	...
	def test_init(self):
		...
		self.assertEqual('11', testme.nullable)
		self.assertEqual('12', testme.remarks)
		self.assertEqual('13', testme.default)
		self.assertEqual('14', testme.sql_data_type)
		self.assertEqual('15', testme.sql_datetime_sub)
		...
		self.assertEqual('19', testme.ss_data_type)
		self.assertFalse(testme.is_pk)
